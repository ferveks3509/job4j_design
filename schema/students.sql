...
select * from students where name LIKE'%E' and course > 2;
select * from students where name LIKE'A%' or course > 1;
select * from students where name LIKE'%D%';
select * from students where course > 1 order by  course DESC;
