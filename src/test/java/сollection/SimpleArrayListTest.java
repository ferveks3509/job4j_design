...
class SimpleArrayListTest {
    ...
    void whenAndAndGetByIncorrectIndexThenGetException() {
        SimpleList<Integer> list = new SimpleArrayList<>(4);
        list.add(5);
        assertThatThrownBy(() -> list.get(5))
                .isInstanceOf(IndexOutOfBoundsException.class);
    }
    ...
    void whenRemoveByInvalidIndexThenGetException() {
        SimpleList<Integer> a = new SimpleArrayList<>(3);
        a.add(1);
        assertThatThrownBy(() -> a.remove(1))
                .isInstanceOf(IndexOutOfBoundsException.class);
    }
    ...
    void whenSetByInvalidIndexThenGetException() {
        SimpleList<Integer> a = new SimpleArrayList<>(1);
        a.add(1);
        assertThatThrownBy(() -> a.set(2, 22))
                .isInstanceOf(IndexOutOfBoundsException.class);
    }
